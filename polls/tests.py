...
class QuestionIndexViewTests(TestCase):
    ...
    def test_future_question(self):
        """
        Question with pub_date in the future are not displayed on the
        index page.
        :return:
        """
...
class QuestionDetailViewTests(TestCase):
    ...
    def test_past_question(self):
        """
        the details view with  a pub date in the past displays the question's text
